...
const CreateCategory = () => {
  ...
  const handleSubmit = async(e) =>{
    ...
    try{
      ...
      toast.error("Something went wrong in creating a category");
    }
  }
...
const handleUpdate = async(e)=>{
  ...
  try{
    ...
    console.log("eeeeeeeeeeee=" + error);
    toast.error("Something went wrong in updating this category");
  }
}
...
const handleDelete = async(pid)=>{
  ...
  try{
    ...
    console.log("eeeeeeeeeeee=" + error);
    toast.error("Something went wrong in deleting this category");
  }
}
